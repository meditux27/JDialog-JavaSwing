...
public class JDialogGridLayout {//Modificar el nombre de la clase a su preferencia o realizar una nueva clase con el nombre presente
       ...
       JButton showDialogButton = new JButton("Mostrar Cuadro de Diálogo");
        ...
        showDialogButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dialog.add(new JButton("Botón 1"));
                dialog.add(new JButton("Botón 2"));
                dialog.add(new JButton("Botón 3"));
                dialog.add(new JButton("Botón 4"));
                dialog.add(new JButton("Botón 5"));
                dialog.add(new JButton("Botón 6"));
